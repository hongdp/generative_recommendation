...
class TIGERCoTModel(nn.Module):
    """TIGER CoT Sequence-to-Sequence Model with Soft Continuous Retrieval."""
    ...
    def setup(self):
        ...
        # Dense layer to project final hidden state into continuous item retrieval space
    ...
    def __call__(
        ...
        Returns:
            ...
            e_outs: Continuous embeddings for soft retrieval, shape [batch, dec_len, 768].
        """
        # 1. Encoder Forward
        ...
        # Continuous output embedding
        e_outs = self.e_out_proj(y)
    ...
    def decode_step(
        ...
        Returns:
            ...
            e_outs: Continuous embedding at the last sequence position, shape [batch, 768].
        """
        dec_emb = self.embed_layer(decoder_tokens)
