...
| 2026-07-11 | Readout A/B arm=begin_timelatenr (HSTU 4x256, sampled-softmax M=1024, untied) on STEAM | Local (GeForce RTX 4080) | 0.19196 | 0.15989 | 0.23397 | 0.17340 | 0.29083 | 0.18772 | 0.16468 | Best val NDCG@10=0.20226 (epoch 23); leak self/rand=0.728/0.001, readout leak=0.018, table align=-0.004 |
| 2026-07-11 | Readout A/B arm=begin_timelatenr (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03524 | 0.02324 | 0.05429 | 0.02937 | 0.07799 | 0.03533 | 0.02612 | Best val NDCG@10=0.04172 (epoch 33); leak self/rand=0.347/0.000, readout leak=0.027, table align=0.001 |
| 2026-07-11 | Readout A/B arm=begin_timelatenr (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03729 | 0.02545 | 0.05308 | 0.03052 | 0.07539 | 0.03612 | 0.02788 | Best val NDCG@10=0.03890 (epoch 22); leak self/rand=0.238/-0.000, readout leak=0.019, table align=0.000 |
| 2026-07-11 | Readout A/B arm=begin_timelatenr (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03497 | 0.02470 | 0.05245 | 0.03036 | 0.07445 | 0.03589 | 0.02777 | Best val NDCG@10=0.04165 (epoch 49); leak self/rand=0.351/-0.001, readout leak=0.037, table align=-0.001 |
| 2026-07-12 | Readout A/B arm=begin_timelatestd (HSTU 4x256, sampled-softmax M=1024, untied) on STEAM | Local (GeForce RTX 4080) | 0.19584 | 0.16348 | 0.23937 | 0.17748 | 0.29755 | 0.19212 | 0.16869 | Best val NDCG@10=0.20567 (epoch 12); leak self/rand=0.578/0.002, readout leak=0.044, table align=0.006 |
| 2026-07-12 | Readout A/B arm=begin_timelatestd (HSTU 4x256, sampled-softmax M=1024, untied) on STEAM | Local (GeForce RTX 4080) | 0.19553 | 0.16414 | 0.23872 | 0.17804 | 0.29662 | 0.19261 | 0.16954 | Best val NDCG@10=0.20523 (epoch 13); leak self/rand=0.444/0.002, readout leak=0.024, table align=0.000 |
| 2026-07-12 | Readout A/B arm=begin_timelatestd (HSTU 4x256, sampled-softmax M=1024, untied) on STEAM | Local (GeForce RTX 4080) | 0.19444 | 0.16320 | 0.23629 | 0.17666 | 0.29376 | 0.19112 | 0.16841 | Best val NDCG@10=0.20475 (epoch 15); leak self/rand=0.603/0.001, readout leak=0.018, table align=0.002 |
| 2026-07-12 | Readout A/B arm=begin_timelatestd (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03989 | 0.02755 | 0.05755 | 0.03325 | 0.08121 | 0.03919 | 0.02998 | Best val NDCG@10=0.04432 (epoch 38); leak self/rand=0.238/0.001, readout leak=0.016, table align=0.003 |
| 2026-07-12 | Readout A/B arm=begin_timelatestd (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03711 | 0.02462 | 0.05590 | 0.03065 | 0.08040 | 0.03679 | 0.02739 | Best val NDCG@10=0.04475 (epoch 30); leak self/rand=0.186/0.002, readout leak=0.032, table align=0.002 |
| 2026-07-12 | Readout A/B arm=begin_timelatestd (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03881 | 0.02643 | 0.05679 | 0.03218 | 0.08317 | 0.03884 | 0.02938 | Best val NDCG@10=0.04478 (epoch 21); leak self/rand=0.161/-0.002, readout leak=0.024, table align=0.002 |
| 2026-07-12 | Readout A/B arm=begin_timebothz (HSTU 4x256, sampled-softmax M=1024, untied) on STEAM | Local (GeForce RTX 4080) | 0.20610 | 0.17010 | 0.25270 | 0.18510 | 0.31354 | 0.20042 | 0.17477 | Best val NDCG@10=0.21165 (epoch 12); leak self/rand=0.376/0.001, readout leak=0.049, table align=0.002 |
| 2026-07-12 | Readout A/B arm=begin_timebothz (HSTU 4x256, sampled-softmax M=1024, untied) on STEAM | Local (GeForce RTX 4080) | 0.20742 | 0.17254 | 0.25381 | 0.18746 | 0.31453 | 0.20274 | 0.17749 | Best val NDCG@10=0.21423 (epoch 13); leak self/rand=0.517/0.000, readout leak=0.026, table align=0.002 |
| 2026-07-12 | Readout A/B arm=begin_timebothz (HSTU 4x256, sampled-softmax M=1024, untied) on STEAM | Local (GeForce RTX 4080) | 0.20512 | 0.16974 | 0.25130 | 0.18459 | 0.31215 | 0.19991 | 0.17453 | Best val NDCG@10=0.21146 (epoch 12); leak self/rand=0.498/-0.000, readout leak=0.048, table align=0.002 |
| 2026-07-12 | Readout A/B arm=begin_timebothz (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03837 | 0.02597 | 0.05701 | 0.03195 | 0.08192 | 0.03823 | 0.02879 | Best val NDCG@10=0.04502 (epoch 24); leak self/rand=0.118/-0.002, readout leak=0.032, table align=0.005 |
| 2026-07-12 | Readout A/B arm=begin_timebothz (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.03989 | 0.02722 | 0.05804 | 0.03310 | 0.08094 | 0.03888 | 0.02962 | Best val NDCG@10=0.04599 (epoch 39); leak self/rand=0.145/-0.000, readout leak=0.028, table align=0.002 |
| 2026-07-12 | Readout A/B arm=begin_timebothz (HSTU 4x256, sampled-softmax M=1024, untied) on BEAUTY | Local (GeForce RTX 4080) | 0.04150 | 0.02859 | 0.06050 | 0.03469 | 0.08308 | 0.04035 | 0.03098 | Best val NDCG@10=0.04635 (epoch 34); leak self/rand=0.119/-0.001, readout leak=0.037, table align=0.005 |
| 2026-07-12 | GenRet E2 (shared backbone, 4-level SID branch, beam 30, HSTU 4x256) on BEAUTY | Local (GeForce RTX 4080) | 0.03586 | 0.02518 | 0.05232 | 0.03048 | 0.07360 | 0.03583 | 0.02599 | Best val NDCG@10=0.04347 (epoch 16); Valid@Beam=0.9593; seed=42; SIDs=semantic_ids_xxl_mlprqvae_dedup_beauty.json |
| 2026-07-12 | GenRet E2 (shared backbone, 4-level SID branch, beam 30, HSTU 4x256) on BEAUTY | Local (GeForce RTX 4080) | 0.03461 | 0.02367 | 0.05178 | 0.02919 | 0.07472 | 0.03495 | 0.02449 | Best val NDCG@10=0.04210 (epoch 14); Valid@Beam=0.9681; seed=123; SIDs=semantic_ids_xxl_mlprqvae_dedup_beauty.json |
| 2026-07-12 | GenRet E2 (shared backbone, 4-level SID branch, beam 30, HSTU 4x256) on BEAUTY | Local (GeForce RTX 4080) | 0.03385 | 0.02349 | 0.04731 | 0.02780 | 0.06837 | 0.03310 | 0.02384 | Best val NDCG@10=0.04220 (epoch 21); Valid@Beam=0.9525; seed=7; SIDs=semantic_ids_xxl_mlprqvae_dedup_beauty.json |
| 2026-07-12 | GenRet E2 (shared backbone, 4-level SID branch, beam 30, HSTU 4x256) on STEAM | Local (GeForce RTX 4080) | 0.16881 | 0.14696 | 0.20219 | 0.15769 | 0.24869 | 0.16939 | 0.14872 | Best val NDCG@10=0.18304 (epoch 22); Valid@Beam=0.9997; seed=42; SIDs=semantic_ids_steam_mlprqvae_dedup.json |
| 2026-07-12 | GenRet E2 (shared backbone, 4-level SID branch, beam 30, HSTU 4x256) on STEAM | Local (GeForce RTX 4080) | 0.16854 | 0.14697 | 0.20240 | 0.15785 | 0.24849 | 0.16945 | 0.14882 | Best val NDCG@10=0.18308 (epoch 25); Valid@Beam=0.9996; seed=123; SIDs=semantic_ids_steam_mlprqvae_dedup.json |
| 2026-07-12 | GenRet E2 (shared backbone, 4-level SID branch, beam 30, HSTU 4x256) on STEAM | Local (GeForce RTX 4080) | 0.16885 | 0.14705 | 0.20287 | 0.15798 | 0.25066 | 0.16997 | 0.14897 | Best val NDCG@10=0.18272 (epoch 13); Valid@Beam=0.9999; seed=7; SIDs=semantic_ids_steam_mlprqvae_dedup.json |

### Time-injection placement + generative-vs-dense fair comparison (2026-07-12)

Design doc §13.12-13.13. Rows: `begin_timelate*`, `begin_timebothz`, `GenRet E2`.
- **Placement**: Steam early wins (late captures 2/3 of gain; the last 1/3 is time-conditioned aggregation); Beauty late wins (weak signal belongs near the logits). early+late does NOT stack (Steam both < early; isolating cell running).
- **Factorization** (from-scratch, equal capacity → pure optimization geometry): residual structure +6.5%/+0.9% HR@10 (Beauty/Steam), zero-init +3.1%/+1.3%; zero>std>non-residual in every cell/seed.
- **E1 vs E2 (headline)**: identical backbone+supervision → dense and generative retrieval are statistically indistinguishable (Steam HR@10 0.20246 vs 0.20249; NDCG@10 identical; Beauty +1.7% HR@10 for generative) with generative using 32% fewer params. Historical TIGER-vs-HSTU gaps were stack differences, not paradigm differences.
