...
| Date | Configuration | Hardware | HR_5 | NDCG_5 | HR_10 | NDCG_10 | HR_20 | NDCG_20 | MRR | Notes |
|:---|:---|:---|---:|---:|---:|---:|---:|---:|---:|:---|
| 2026-06-06 | Full HSTUModel (4 blocks, embed=256) on ML-1M | Local (GeForce RTX 4080) | 0.13212 | 0.08459 | 0.20414 | 0.10770 | - | - | 0.09371 | Best Val NDCG_10=-1.00000; Test metrics replicated |
...
| 2026-06-07 | TIGER Joint V2 (End-to-End Indexing) on STEAM | Local | 0.18432 | 0.10905 | 0.18737 | 0.11001 | 0.22052 | 0.11880 | 0.08833 | Joint token+item soft-reconstruction, frozen Z anchoring |
| 2026-06-07 | Full TIGER (Seq2Seq) (blocks=4, embed=384) on STEAM | Local (GeForce RTX 4080) | 0.06426 | 0.06042 | 0.06783 | 0.06158 | 0.06995 | 0.06213 | 0.05979 | Replication on steam matching TIGER paper evaluation (Best Val NDCG_10=0.09563) |
| 2026-06-07 | TIGER RL-CoT (End-to-End Latent Routing) on STEAM | Local (GeForce RTX 4080) | 0.00042 | 0.00036 | 0.00050 | 0.00039 | 0.00063 | 0.00042 | 0.00036 | Replication on steam matching TIGER paper evaluation (Best Val NDCG_10=0.00066) |
